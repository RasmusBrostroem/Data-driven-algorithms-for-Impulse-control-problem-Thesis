...
MISEKernel <- ggplot(AvgData, aes(x=ST, group=kernelMethod))+
  ...
  theme(plot.margin = unit(c(0.5,0.1,0.1,0.5),"cm"),
...
ggplot(AvgDataCdf, aes(x=ST, group=CText))+
  geom_line(aes(y=avgMiseCdf, color=CText), size = 1.5)+
  ylab("Mean integrated squared error (MISE)")+
  xlab("Exploration time (ST)")+
  ggtitle("Mean integrated squared error for empirical distribution function")+
  labs(color = "Drift slope")+
  scale_color_manual(values = c("Drift slope = 0.1" = "#4477AA",
                                "Drift slope = 0.5" = "#EE6677",
                                "Drift slope = 2" = "#228833",
                                "Drift slope = 4" = "#CCBB44"))+
  theme_bw()+
  scale_y_continuous(breaks = scales::pretty_breaks(n = 4))+
...
ggplot(AvgDataCdf, aes(x=ST, group=CText))+
  ...
  ylab("Standard deviation of integrated squared error")+
  xlab("Exploration time (ST)")+
  ggtitle("Standard deviation of integrated squared error for empirical distribution function")+
  labs(color = "Drift slope")+
  scale_color_manual(values = c("Drift slope = 0.1" = "#4477AA",
                                "Drift slope = 0.5" = "#EE6677",
                                "Drift slope = 2" = "#228833",
...
MISEBWa <- ggplot(avgData_a, aes(x=ST, group=aText))+
  ...
  theme(plot.margin = unit(c(0.5,0.1,0.1,0.5),"cm"),
        ...
        strip.text = element_text(size=11),
        legend.justification= c(1, 0), 
        #legend.position = c(0.48, 0.88),
        legend.position = c(0.24, 0.7),
        legend.key = element_blank(),
        legend.title = element_blank(),
        legend.text = element_text(size=11),
        legend.margin = margin(0, 0, 0, 0),
