...
ggplot(avgData, aes(x=T, group=CText))+
  ...
  facet_grid(zeroValText ~ pText, scales="fixed")+
  theme_bw()+
...
ggplot(avgData, aes(x=T, group=CText))+
  ...
  scale_color_manual(values = c("C = 0.1" = "#66c2a5",
                                ...
                                "C = 4" = "#8da0cb"))+
  labs(color = "Drift Slope")+
  facet_grid(zeroValText ~ pText, scales="free")+
  theme_bw()+
  scale_y_continuous(breaks = scales::pretty_breaks(n = 5))+
  theme(plot.title = element_text(face = "bold", size=13),
        axis.title.x = element_text(size=12),
...
ggplot(tmpData, aes(x=T))+
  ...
  xlab("Time horizon (T)")+
  ggtitle("Average exploration time for drift and payoff functions with a=0.7")+
  facet_grid(pText ~ CText, scales="free")+
  theme_bw()+
  scale_y_continuous(breaks = scales::pretty_breaks(n = 5))+
  theme(plot.title = element_text(face = "bold", size=13),
...
ggplot(tmpData, aes(x=T, group=CText))+
  ...
  xlab("Time horizon (T)")+
  ggtitle("Difference in number of decisions made by optimal and data-driven strategy (a=0.99)")+
  scale_color_manual(values = c("C = 0.1" = "#66c2a5",
                                "C = 0.5" = "#fc8d62",
                                "C = 4" = "#8da0cb"))+
  labs(color = "Drift Slope")+
...
```{r}
tmpData <- thresholds %>% filter(zeroVal == 0.9, power==1)

ggplot(thresholds, aes(ST))+
  geom_histogram(aes(y = after_stat(count / sum(count))), bins=50, color = "#000000", fill = "#1f78b4")+
  ylab("Percentage of estimates made")+
  xlab("Exporation time (ST)")+
  ggtitle("Percentage of estimates made at different exploration times")+
...
ggplot(data=DriftAndRewardThresholds, aes(cut_number, diffToOptimal))+
  geom_boxplot(aes(color=CText),outliers = T, outlier.size =0.7)+
  ...
  ggtitle("Difference between estimated and optimal threshold for exploration intervals (a=0.99)")+
  scale_color_manual(values = c("C = 0.1" = "#66c2a5",
                                "C = 0.5" = "#fc8d62",
                                "C = 4" = "#8da0cb"))+
  labs(color = "Drift Slope")+
