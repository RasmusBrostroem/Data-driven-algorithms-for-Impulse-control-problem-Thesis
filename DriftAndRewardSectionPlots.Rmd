...
ggplot(tmpData, aes(x=T, group=CText))+
  ...
  xlab("Time horizon (T)")+
  ggtitle("Average cumulative regret for drift and payoff functions (a=0.99)")+
...
ggplot(tmpData, aes(x=T, group=CText))+
  ...
  xlab("Time horizon (T)")+
  ggtitle("Standard deviation of cumulative regret for drift and payoff functions (a=0.99)")+
  scale_color_manual(values = c("C = 0.1" = "#66c2a5",
                                "C = 0.5" = "#fc8d62",
                                "C = 4" = "#8da0cb"))+
  labs(color = "Drift Slope")+
...
```{r}
tmpData <- avgDataPerTime %>% filter(zeroVal == 0.99)

ggplot(tmpData, aes(x=T, group=CText))+
  geom_line(aes(y=avgRegret, color=CText), size=1.2)+
  ylab("Average cumulative regret per time unit")+
  xlab("Time horizon (T)")+
  ggtitle("Average cumulative regret per time unit for drift and payoff functions (a=0.99)")+
  scale_color_manual(values = c("C = 0.1" = "#66c2a5",
                                "C = 0.5" = "#fc8d62",
                                "C = 4" = "#8da0cb"))+
  labs(color = "Drift Slope")+
...
ggplot(tmpData, aes(x=T, group=CText))+
  ...
  xlab("Time horizon (T)")+
  ggtitle("Standard deviation of cumulative regret per time unit (a=0.99)")+
  scale_color_manual(values = c("C = 0.1" = "#66c2a5",
                                "C = 0.5" = "#fc8d62",
                                "C = 4" = "#8da0cb"))+
  labs(color = "Drift Slope")+
