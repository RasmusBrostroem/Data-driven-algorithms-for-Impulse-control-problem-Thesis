...
ggplot(avgData, aes(x=T, group=diffusionFunc))+
  ...
  facet_grid(aText ~ pText, scales="fixed")+
  theme_bw()+
...
ggplot(tmpData, aes(x=T))+
  ...
  facet_grid(aText ~ pText, scales="free")+
  theme_bw()+
  scale_y_continuous(breaks = scales::pretty_breaks(n = 5))+
  theme(plot.title = element_text(face = "bold", size=13),
        axis.title.x = element_text(size=12),
...
ggplot(thresholds, aes(ST))+
  ...
  facet_grid(aText~diffusionFunc, scales="fixed")+
  theme_bw()+
  theme(plot.title = element_text(face = "bold", size=13),
        axis.title.x = element_text(size=12),
        axis.title.y = element_text(size=12),
...
ggplot(data=thresholds, aes(cut_number, diffToOptimal))+
  geom_boxplot(aes(color=diffusionFunc), outliers = T, outlier.size = 0.7)+
